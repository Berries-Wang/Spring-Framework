...
public abstract class AbstractAspectJAdvice implements Advice, AspectJPrecedenceInformation, Serializable {
	...
	public void setArgumentNamesFromStringArray(String... args) {
		...
		if (this.argumentNames != null) {
			/**
			 *this.aspectJAdviceMethod： 切面方法
			 * this.argumentNames 来源于 org.aspectj.lang.annotation.Before#argNames()
			 */
			if (this.aspectJAdviceMethod.getParameterCount() == this.argumentNames.length + 1) {
				// May need to add implicit（adj. 含蓄的；暗示的；盲从的） join point arg name...
	...
	private void bindArgumentsByName(int numArgumentsExpectingToBind) {
		if (this.argumentNames == null) {
			// org.aspectj.lang.annotation.Before.argNames 获取这里面的参数值
